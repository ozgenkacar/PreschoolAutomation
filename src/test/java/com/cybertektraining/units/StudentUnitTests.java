   ...
   @Test
    public void test1(){
       try{
           ...
           Assert.assertEquals("1/01/1990",student_from_json.getBirthDate());
           Assert.assertEquals("alps road",student_from_json.getCompany().getAddress().getStreet());
           Assert.assertEquals("om@gmail.com",student_from_json.getContact().getEmailAddress());
       }catch (IOException e){
           e.printStackTrace();
       }
